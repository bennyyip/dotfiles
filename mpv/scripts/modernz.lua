...
-- MY PATCH BEGIN
local function no_rounded_corner()
    local mt = getmetatable(assdraw.ass_new())
    round_rect_cw_orig = mt.round_rect_cw
    mt.round_rect_cw = function (ass, x0, y0, x1, y1, r1, r2)
        round_rect_cw_orig(ass, x0, y0, x1, y1, 0, 0)
    end
end
